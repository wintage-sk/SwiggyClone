import { SHIMMER_MENU_ITEMS_COUNT,SHIMMER_RES_CARDS_COUNT } from "../utils/constants";

const CardShimmer = () => {
  return (
    <div className="basis-[250px] mob:basis-[150px] p-2.5 mb-2.5 shadow animate-pulse">
      <div className="h-[144px] w-[230px] bg-blue-300 mob:w-[130px] mob:h-[81px]"></div>
      <div className="w-3/5 mt-2.5 h-[15px]"></div>
      <div className="w-4/5 mt-1 h-[15px]   bg-blue-300"></div>
      <div className="w-full mt-[18px] h-[15px]   bg-blue-300 "></div>
    </div>
  );
}
...
export const MenuShimmer = () => {
  return (
    <div className="container animate-pulse">
      <div className="flex basis-full h-60 justify-evenly items-center p-8 bg-blue-300 ">
          ...
          <div className="menu-items-list  flex flex-col justify-evenly">
            ...
            <div className="flex justify-evenly w-[848px] p-2.5 mb-2.5 shadow animate-pulse" key={index}>
              ...
              <div className="flex flex-col justify-center items-center w-[118px] h-[150px]">
                ...
                <div className="w-[94px] h-[34px] mt-2.5bg-blue-300"> </div>
              </div>
            </div>
            )}
          </div>
